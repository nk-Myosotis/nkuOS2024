...
int kern_init(void) {
    ...
    8020002a:	49a58593          	add	a1,a1,1178 # 802004c0 <memset+0x12>
    8020002e:	00000517          	auipc	a0,0x0
    80200032:	4b250513          	add	a0,a0,1202 # 802004e0 <memset+0x32>
...
int cprintf(const char *fmt, ...) {
    ...
    80200064:	004c                	add	a1,sp,4
    80200066:	00000517          	auipc	a0,0x0
    8020006a:	fd650513          	add	a0,a0,-42 # 8020003c <cputch>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200090:	02069813          	sll	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
    80200094:	7179                	add	sp,sp,-48
    unsigned mod = do_div(result, base);
    80200096:	02085813          	srl	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
    802000ac:	fff7041b          	addw	s0,a4,-1
    unsigned mod = do_div(result, base);
    ...
    802000d6:	41678793          	add	a5,a5,1046 # 802004e8 <memset+0x3a>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    8020012e:	472a8a93          	add	s5,s5,1138 # 8020059c <memset+0xee>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    80200132:	000c4503          	lbu	a0,0(s8)
    80200136:	001c0413          	add	s0,s8,1
    ...
    8020015e:	00140c13          	add	s8,s0,1
    80200162:	fdd6859b          	addw	a1,a3,-35
    80200166:	0ff5f593          	zext.b	a1,a1
    8020016a:	02bb6663          	bltu	s6,a1,80200196 <vprintfmt+0x98>
    8020016e:	058a                	sll	a1,a1,0x2
    ...
    802001c2:	fd068d1b          	addw	s10,a3,-48
                if (ch < '0' || ch > '9') {
    802001c6:	fd07859b          	addw	a1,a5,-48
                ch = *fmt;
    ...
    802001d6:	00144783          	lbu	a5,1(s0)
                precision = precision * 10 + ch - '0';
    802001da:	002d171b          	sllw	a4,s10,0x2
    802001de:	01a7073b          	addw	a4,a4,s10
    802001e2:	0017171b          	sllw	a4,a4,0x1
    802001e6:	9f35                	addw	a4,a4,a3
                if (ch < '0' || ch > '9') {
    802001e8:	fd07859b          	addw	a1,a5,-48
            for (precision = 0; ; ++ fmt) {
    802001ec:	0405                	add	s0,s0,1
                precision = precision * 10 + ch - '0';
    802001ee:	fd070d1b          	addw	s10,a4,-48
                ch = *fmt;
    ...
    80200300:	3cfd                	addw	s9,s9,-1
    80200302:	0a05                	add	s4,s4,1
    ...
    802003f0:	115a0a13          	add	s4,s4,277 # 80200501 <memset+0x53>
    ...
    8020042e:	0d650513          	add	a0,a0,214 # 80200500 <memset+0x52>
    80200432:	060000ef          	jal	80200492 <strnlen>
    80200436:	40ac8cbb          	subw	s9,s9,a0
                p = "(null)";
    8020043a:	00000417          	auipc	s0,0x0
    8020043e:	0c640413          	add	s0,s0,198 # 80200500 <memset+0x52>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    80200442:	00000a17          	auipc	s4,0x0
    80200446:	0bfa0a13          	add	s4,s4,191 # 80200501 <memset+0x53>
...
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
    80200458:	715d                	add	sp,sp,-80
    va_start(ap, fmt);
    8020045a:	02810313          	add	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
