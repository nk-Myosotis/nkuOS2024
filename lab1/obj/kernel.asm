...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003c8:	06f76b63          	bltu	a4,a5,8020043e <interrupt_handler+0x80>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200408:	e822                	sd	s0,16(sp)
            ...
            */
            if(ticks==100)
    8020040a:	00004417          	auipc	s0,0x4
    8020040e:	c0640413          	addi	s0,s0,-1018 # 80204010 <ticks>
void interrupt_handler(struct trapframe *tf) {
    80200412:	e426                	sd	s1,8(sp)
            if(ticks==100)
    80200414:	6004                	ld	s1,0(s0)
void interrupt_handler(struct trapframe *tf) {
    80200416:	ec06                	sd	ra,24(sp)
            if(ticks==100)
    80200418:	06400793          	li	a5,100
    8020041c:	02f48263          	beq	s1,a5,80200440 <interrupt_handler+0x82>
            	{
            		sbi_shutdown();
            	}
            	ticks=0;
    ...
    80200420:	d41ff0ef          	jal	ra,80200160 <clock_set_next_event>
            ticks+=1;
    ...
    80200428:	64a2                	ld	s1,8(sp)
            ticks+=1;
    8020042a:	0785                	addi	a5,a5,1
    8020042c:	e01c                	sd	a5,0(s0)
}
    8020042e:	6442                	ld	s0,16(sp)
    80200430:	6105                	addi	sp,sp,32
    80200432:	8082                	ret
            cprintf("Supervisor external interrupt\n");
    80200434:	00001517          	auipc	a0,0x1
    80200438:	a9450513          	addi	a0,a0,-1388 # 80200ec8 <etext+0x520>
    8020043c:	b13d                	j	8020006a <cprintf>
            print_trapframe(tf);
    8020043e:	b705                	j	8020035e <print_trapframe>
    cprintf("%d ticks\n", TICK_NUM);
    80200440:	06400593          	li	a1,100
    80200444:	00001517          	auipc	a0,0x1
    80200448:	a7450513          	addi	a0,a0,-1420 # 80200eb8 <etext+0x510>
    ...
    80200460:	00978763          	beq	a5,s1,8020046e <interrupt_handler+0xb0>
            	ticks=0;
    80200464:	00004797          	auipc	a5,0x4
    80200468:	ba07b623          	sd	zero,-1108(a5) # 80204010 <ticks>
    8020046c:	bf55                	j	80200420 <interrupt_handler+0x62>
            		sbi_shutdown();
    8020046e:	4f2000ef          	jal	ra,80200960 <sbi_shutdown>
    80200472:	bfcd                	j	80200464 <interrupt_handler+0xa6>
